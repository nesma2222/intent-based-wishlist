...
export const sampleProducts: Product[] = [
  ...
  { id: "20", name: "Gaming Chair", category: "gaming", price: 8000, image: "https://images.unsplash.com/photo-1598550476439-6847785fcea6?w=400&h=300&fit=crop" },
  ...
  { id: "18", name: "Bluetooth Speaker", category: "discount", price: 1500, discount: 35, offerExpiry: Date.now() + 2 * 60 * 60 * 1000, image: "https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=400&h=300&fit=crop" },
  { id: "19", name: "Sunglasses", category: "discount", price: 800, discount: 25, offerExpiry: Date.now() + 4 * 60 * 60 * 1000, image: "https://images.unsplash.com/photo-1572635196237-14b3f281503f?w=400&h=300&fit=crop" },
];